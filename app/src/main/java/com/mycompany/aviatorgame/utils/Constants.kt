...
object Constants {
    ...
    fun getCrashProbability(multiplier: Float): Float {
        return when {
            multiplier < 1.5f -> 0.01f  // 1% для x1.0-1.5
            multiplier < 2f -> 0.02f    // 2% для x1.5-2.0
            multiplier < 3f -> 0.03f    // 3% для x2.0-3.0
            multiplier < 5f -> 0.05f    // 5% для x3.0-5.0
            multiplier < 10f -> 0.08f   // 8% для x5.0-10.0
            multiplier < 20f -> 0.12f   // 12% для x10.0-20.0
            multiplier < 50f -> 0.20f   // 20% для x20.0-50.0
            else -> 0.35f                // 35% для x50.0+
        }
    }
